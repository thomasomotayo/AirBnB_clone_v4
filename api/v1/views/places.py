...
def places_per_city(city_id=None):
    """
        places route that handles http method for requested places by city
    """
...
def places_with_id(place_id=None):
    """
        this places route to handle http methods for given place
    """
...
def places_search():
    """
        it places route to handle http method for request to search places
    """
